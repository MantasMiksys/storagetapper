...
It is also aware of node roles and takes snapshots from slave nodes in order 
to reduce load on master nodes. It can also optionally further throttle its reads.
